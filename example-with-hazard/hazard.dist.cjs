...
var uuid = getCjsExportFromNamespace(esmNode);

console.log('REQUIRE UUID');

var uuidDualPackageHazard = uuid;
...
const firstHazardv1 = uuidDualPackageHazard.v1();
const secondHazardv1 = uuidDualPackageHazard.v1();
